    ...
    <Box>
      <Alert severity="info" sx={{ mb: 3 }}>
        ...
        <Typography variant="body2">
          ...
          Always consult with a qualified homeopathic practitioner before starting any treatment.
        </Typography>
      </Alert>
      ...
      {treatments && treatments.length > 0 ? (
        ...
        <Paper elevation={1} sx={{ p: 3 }}>
          <Typography variant="body2" color="text.secondary">
            No Homeopathy treatment information available for this assessment.
          </Typography>
        </Paper>
      )}
    </Box>
...
export default HomeopathyPanel;
