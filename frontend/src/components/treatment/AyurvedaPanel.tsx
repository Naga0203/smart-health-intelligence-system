...
export const AyurvedaPanel: React.FC<AyurvedaPanelProps> = ({ treatments }) => {
  return (
    <Box>
      <Alert severity="info" sx={{ mb: 3 }}>
        ...
        <Typography variant="body2">
          ...
          Always consult with a qualified Ayurvedic practitioner before starting any treatment.
        </Typography>
      </Alert>
      ...
      {treatments && treatments.length > 0 ? (
        ...
        <Paper elevation={1} sx={{ p: 3 }}>
          <Typography variant="body2" color="text.secondary">
            No Ayurveda treatment information available for this assessment.
          </Typography>
        </Paper>
      )}
    </Box>
