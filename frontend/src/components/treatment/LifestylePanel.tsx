    ...
    <Box>
      <Alert severity="info" sx={{ mb: 3 }}>
        ...
        <Typography variant="body2">
          ...
          Always consult with a qualified healthcare provider before making significant lifestyle changes.
        </Typography>
      </Alert>
      ...
      {treatments && treatments.length > 0 ? (
        ...
        <Paper elevation={1} sx={{ p: 3 }}>
          <Typography variant="body2" color="text.secondary">
            No lifestyle treatment information available for this assessment.
          </Typography>
        </Paper>
      )}
    </Box>
